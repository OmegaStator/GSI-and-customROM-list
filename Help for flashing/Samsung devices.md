...
- OneUI8 entirely removes the OEM unlock option, not depending of your country or your career, you will probably have to use an exploit to unlock the bootloader if you have OneUI8 or more
...
- No, i'm here to help you, not to fix your ROM, for custom ROMs, tell about your bug to the dev. If you are on a GSI, i hope it's not a major bug because they tend to be slower or unmaintained (because of differences between all the devices)
